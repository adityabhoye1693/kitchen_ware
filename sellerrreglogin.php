        ...
        <div class="row">
          <div class="col-lg-4">
            <div class="section-title" data-aos="fade-right">
              <h2>Seller Login/Register</h2>
              <p>Online platform links customer to buyers Buy and sell your kitchen tools produce online free - sell or buy kitchen utensils product online....<br></p>
            </div>
          </div>
          <div class="col-lg-8">
            <div class="row">
              ...
              <div class="col-md-6 d-flex align-items-stretch">
                <div class="icon-box" data-aos="zoom-in" data-aos-delay="100" style="width: 100%;">
                  ...
                  <h4><a href="sellerloginpanel.php">Existing Seller</a></h4>
