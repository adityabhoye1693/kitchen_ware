...
<head>
  ...
  <title>Kitchen Ware</title>
  <meta content="" name="kitchen ware Web Portal helps customer by providing all kinds kitchen tools related information in the website.">
  <meta content="Kitchen Tools Management System, kitchen ware" name="keywords">
    ...
    <div class="container">
      <div class="header-container d-flex align-items-center">
        <div class="logo mr-auto">
          <h1 class="text-light"><a href="index.php"><span>Kitechn Ware</span></a></h1>
        </div>
        ...
        <nav class="nav-menu d-none d-lg-block">
          <ul>
			...
			<li class="drop-down <?php
                            ...
                            ?>"><a href="displaysales.php" onclick='window.location=`displaysales.php`'>Kitchen Tools</a>
              <ul>
<?php
...
?>
	...
	<li class="drop-down"><a href="#">Sale</a>
	  <ul>
			
			<li><a href="displayarticles.php?articletype=Blog">Offers</a></li>
	  </ul>
	</li>
...
<li class="drop-down <?php
  ...
  <ul>
    ...
    <li><a href="viewpurchaserequest.php">View Kittchen's Produce Purchase request</a></li>
    <li><a href="viewcstpurchaseorder.php">View Kitchen's Produce Purchase Order</a></li>
...
<li class="drop-down <?php
                            ...
                            ?>" ><a href="">My Account</a>
  <ul>
	<li><a href="sellerpanel.php">Seller Panel</a></li>
	...
	<li class="drop-down"><a href="#">Sales Report</a>
	  <ul>
  ...
  <ul>
	...
	<li class="drop-down"><a href="#">Report</a>
	  <ul>
		...
		<li><a href="viewseller.php">Sellers Report</a></li>
	...
	<li class="drop-down"><a href="#">Seller Settings</a>
	  <ul>
...
<li><a href="viewProduce.php">View Produce types</a></li>
	...
	<li class="drop-down"><a href="#">Sale</a>
	  <ul>
<li><a href="article.php">Publish Sale Articles</a></li>
<li><a href="viewarticle.php">View Sale Articles</a></li>
	  </ul>
	</li>
...
<li class="drop-down"><a href="">My Account</a>
  <ul>
	...
	<li><a href="sellerrrlogin.php">Seller Account</a></li>
  </ul>
</li>
<?php
}
